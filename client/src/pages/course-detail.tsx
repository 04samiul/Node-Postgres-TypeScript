    ...
    >
      ...
      {totalContent > 0 ? (
        <Tabs defaultValue="all" className="w-full">
          <TabsList
            className="w-full justify-start mb-4 overflow-x-auto"
            data-testid="tabs-course-content"
          >
          ...
          <TabsContent value="all">
            {classesLoading || resourcesLoading || mocksLoading ? (
              ...
              <EmptyState
                ...
                text="No content added to this course yet."
              />
            )}
          </TabsContent>
          ...
          <TabsContent value="classes">
            {classesLoading ? (
              ...
              <EmptyState
                ...
                text="No classes added to this course yet."
              />
            )}
          </TabsContent>
          ...
          <TabsContent value="resources">
            {resourcesLoading ? (
              ...
              <EmptyState
                ...
                text="No resources added to this course yet."
              />
            )}
          </TabsContent>
          ...
          <TabsContent value="mocks">
            {mocksLoading ? (
              ...
              <EmptyState
                icon={<BookOpen className="h-10 w-10" />}
                text="No mock tests added to this course yet."
              />
            )}
          </TabsContent>
        </Tabs>
